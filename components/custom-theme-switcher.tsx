...
export const CustomToggle = () => {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="group flex h-9 w-9 cursor-pointer select-none items-center justify-center gap-2 rounded-full bg-background text-zinc-700 transition-all duration-200 [box-shadow:inset_3px_3px_6px_#d1d1d1,inset_-1px_-1px_2px_#d1d1d1] hover:brightness-[1.02] active:scale-[0.98]  border-none dark:text-zinc-100 dark:[box-shadow:inset_2px_2px_6px_#222222,inset_-2px_-2px_4px_#121212]"
